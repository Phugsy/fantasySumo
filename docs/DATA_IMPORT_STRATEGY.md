...
7. Add a protected scheduled production trigger that locks the eligible basho
   on day 0 without fetching results, then derives the current day in Japan
   time and reuses the result import service on days 1-15. Allow
   upcoming-or-locked to active progression on day 1 and complete the basho
